...
const TokenHolderPage = () => {
  ...
  return (
    <div className="w-full max-w-5xl mx-auto py-6 px-2">
      {/* Navigation menu with custom buttons and Tailwind styling */}
      {/* Responsive selector menu */}
      <div>
        {/* Mobile selector: dropdown menu */}
        <div className="block md:hidden w-full mb-6 mt-10">
          <select
        ...
        {/* Desktop selector: current layout */}
        <div className="hidden md:flex flex-wrap gap-2 justify-center mt-10 mb-6">
          {sections.map((section) => (
            <button
              key={section}
              type="button"
      ...
      {/* Active Section wrapped in Windmill Card */}
      <Card className="p-6 !bg-[rgba(50,50,50,0.8)] !ring-0 border border-gold rounded-lg shadow-lg backdrop-blur w-full max-w-5xl mx-auto overflow-x-auto">
